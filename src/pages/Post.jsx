                        ...
                        <>
                            <div className="md:p-3 p-1">
                                <div className="md:mt-10">
                                    <div className="md:w-10/12 mx-auto xl:w-3/5">
                                    ...
                                    <div className="md:w-[85%] lg:w-[65%] xl:w-[55%]  mx-auto my-10">
                                        <div className="dark:text-white p-3 text-pretty text-xl w-full"
