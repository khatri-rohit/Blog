    ...
    return (
        <div className="fixed bottom-4 left-4 z-50 md:bottom-4 md:right-4">
            {!isOpen ? (
                ...
                <div className={`bg-white rounded-lg shadow-xl w-[85%] sm:w-96 ${isMinimized ? 'h-12' : 'h-[545px]'} flex ml-auto flex-col`}>
                    {/* Chat Header */}
                    <div className="bg-blue-600 text-white p-2 sm:p-3 rounded-t-lg flex justify-between items-center">
                    ...
                    {!isMinimized && (
                        <>
                                ...
                                {messages.map((message, index) => (
                                    <div
                                        ...
                                        {message.type === 'loading' ? (
                                            <div className="flex items-center space-x-2 bg-gray-100 dark:bg-gray-700 rounded-lg p-2 sm:p-3">
                                                <div className="w-2 h-2 bg-gray-600 rounded-full animate-bounce"></div>
                                                <div className="w-2 h-2 bg-gray-600 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                                                <div className="w-2 h-2 bg-gray-600 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                                            </div>
                                        ) : (
                                            <div className={`max-w-full md:max-w-[80%] p-2 sm:p-3 rounded-lg ${message.type === 'user'
                            ...
                            {/* Chat Input */}
                            <form onSubmit={handleSubmit} className="p-2 border-t border-gray-200 dark:border-gray-600 sm:p-4">
                                <div className="flex gap-1 sm:gap-2">
                                    <input
                                        ...
                                        className="flex-1 p-1 sm:p-2 border rounded-lg focus:outline-none focus:border-blue-600 dark:bg-gray-700 dark:border-gray-600 dark:focus:border-blue-500"
                                    />
                                    <button
                                        type="submit"
                                        className="bg-blue-600 text-white p-1 sm:p-2 rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors"
                                    >
                                        <Send size={20} />
                                    </button>
                                </div>
